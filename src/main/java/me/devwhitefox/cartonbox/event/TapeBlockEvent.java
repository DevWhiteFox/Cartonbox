...
public class TapeBlockEvent extends org.bukkit.event.Event implements Cancellable {
    ...
    public TapeBlockEvent(org.bukkit.block.Block whatBlock, Player whoTape) {
